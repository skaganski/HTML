...
function hangi_loom($id){
	...
	$sql ="SELECT nimi, vanus, liik, PUUR FROM skaganski_loomaaed2 WHERE id='$id'";
			...
			if($_SERVER['REQUEST_METHOD'] == 'POST') {
				if($_POST["id"] == ''){
					...
					$muutuja = hangi_loom($_POST["id"]);
						...
						$sql = "UPDATE skaganski_loomaaed2 SET nimi='$nimi', puur ='$puur', liik = '$liik' WHERE id='$eraldi_id'";
						$result = mysqli_query($connection, $sql);
